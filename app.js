...
function addRound() {
  ...
  roundDiv.innerHTML = `
    <h3>Round ${roundId + 1} <button class="btn btn-sm btn-danger float-end ms-2" onclick="deleteRound(${roundId})">Delete</button>
    <button class="btn btn-sm btn-outline-secondary float-end" onclick="toggleRound(${roundId})">Toggle</button></h3>
